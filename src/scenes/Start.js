...
showRotatePhoneScreen (nextFunction)
{
    ...
    this.addQuestionObject(this.add.rectangle(640, 360, 1200, 430, 0xffffff))
    ...
    showSurvivalCheckQuestion ()
    {
        ...
        this.addQuestionObject(this.add.rectangle(640, 360, 1040, 450, 0xffffff))
            .setStrokeStyle(4, 0x000000);
    ...
    showSurvivalCheckFeedback (message)
    {
        ...
        this.addQuestionObject(this.add.rectangle(640, 360, 1040, 320, 0xffffff))
            .setStrokeStyle(4, 0x000000);
...
showGroupDistributionPreferenceQuestion ()
{
    ...
    this.addQuestionObject(this.add.rectangle(640, 460, 1200, 340, 0xffffff))
        .setStrokeStyle(4, 0x000000);
...
showRedistributionRulesQuestion ()
{
    ...
    this.addQuestionObject(this.add.rectangle(640, 360, 1220, 520, 0xffffff))
        .setStrokeStyle(4, 0x000000);
...
showSocialContractQuestion ()
{
    ...
    this.addQuestionObject(this.add.rectangle(640, 360, 1220, 500, 0xffffff))
        .setStrokeStyle(4, 0x000000);
...
showWorkBreakQuestion ()
{
    ...
    this.addQuestionObject(this.add.rectangle(640, 465, 1220, 360, 0xffffff))
        .setStrokeStyle(4, 0x000000);
...
showFloodRiskInstructionScreen ()
{
    ...
    this.addQuestionObject(this.add.rectangle(640, 360, 1220, 560, 0xffffff))
        .setStrokeStyle(4, 0x000000);
...
showPersonDShareQuestion ()
{
    ...
    this.addQuestionObject(this.add.rectangle(640, 425, 1220, 300, 0xffffff))
        .setStrokeStyle(4, 0x000000);
...
showPersonDEmpathyQuestion ()
{
    ...
    this.addQuestionObject(this.add.rectangle(640, 450, 1220, 350, 0xffffff))
        .setStrokeStyle(4, 0x000000);
...
showCooperationCompetitionQuestion ()
{
    ...
    this.addQuestionObject(this.add.rectangle(640, 455, 1220, 360, 0xffffff))
        .setStrokeStyle(4, 0x000000);
...
showNextTaskButtonAt (x, y, callback)
{
    ...
    const button = this.add.rectangle(x, buttonY, 260, 55, 0x000000);
    button.setInteractive({ useHandCursor: true });
    button.setDepth(50);
...
showNextTaskButton (callback)
{
    ...
    const button = this.add.rectangle(640, buttonY, 260, 55, 0x000000);
    button.setInteractive({ useHandCursor: true });
    button.setDepth(50);
